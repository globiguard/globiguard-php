...
Report suspected vulnerabilities privately through GitHub security advisories for `globiguard/globiguard-php`.
...
- Keep Composer runtime dependencies at zero unless a reviewed security need outweighs the supply-chain cost.
